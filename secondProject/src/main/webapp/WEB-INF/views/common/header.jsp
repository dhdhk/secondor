				...
				<td>
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse " id="navbarTogglerDemo03">
							<form action="<c:url value="/main.do" />" class="d-flex translate-middle" role="search"
								style="width: 50%">
								<input class="form-control me-2 " type="search"
									placeholder="상품명을 검색해주세요" aria-label="Search">
								<button class="btn btn-outline-success" type="submit">검색</button>
							</form>
							<ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
								<c:choose>
									<c:when test="${isLogOn == true && member != null }">
										<li class="nav-item"><a class="nav-link">환영합니다.
												${member.user_name }님!</a></li>
										<li class="nav-item"><a class="nav-link"
											href="${contextPath }/write/writeForm.do">상품등록</a></li>
										<li class="nav-item"><a class="nav-link" href="${contextPath }/member/logout.do">로그아웃</a>
										</li>
										<li class="nav-item"><a class="nav-link"
											href="${contextPath }/chat/chatForm.do?user_id=${member.user_id}">채팅(시험용)</a>
										</li>
									</c:when>
									<c:otherwise>
										<li class="nav-item"><a class="nav-link"
										...
										<li class="nav-item"><a class="nav-link"
											href="${contextPath }/write/writeForm.do">글쓰기</a></li>
									</c:otherwise>
								</c:choose>
							</ul>
						</div>
				...
				<td>
					<div>
						<ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
							...
							<li class="nav-item"><a class="nav-link"
								href="${contextPath }/viewList.do?category_name=bedroom">침실</a>
							</li>
							<li class="nav-item"><a class="nav-link"
								href="${contextPath }/viewList.do?category_name=bathroom">화장실</a>
							</li>
							<li class="nav-item"><a class="nav-link"
...
>>>>>>> branch 'master' of https://github.com/eumssooo/acornSecondProject.git
	</nav>
</body>
