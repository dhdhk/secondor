			...
			<div class="pageNum">            
				<div class="">
					<c:if test="${beginPage>1 }">
						<a href="${contextPath }/viewList.do${ch.cc.getQueryString(beginPage-5)}" class="btn btn-sm btn-info" style="border: none;background-color: #5A7EFF;">&lt;</a> 
					</c:if>
					<c:if test="${beginPage<=1 }">
					...
					<c:if test="${beginPage+4<endPage }">
						<a href="${contextPath }/viewList.do${ch.cc.getQueryString(beginPage+5)}" class="btn btn-sm btn-success" style="border: none;background-color: #5A7EFF;">&gt;</a>
					</c:if>
					<c:if test="${beginPage+4>=endPage }">
